                    ...
                    <div class="cow-container">
                        <div class="cow-div">
                            ...
                            <div class="cow-dets">
                                ...
                                <form @submit.prevent="appStore.saveShippingAddress(userShippingAddress)" id="checkoutForm">
                                    <div class="form-grid-wrp">
                                        ...
                                        <div>
                                            <FormInput
                                                ...
                                                label-for="phone2-field"
                                                input-type="tel"
                                                input-id="phone2-field"
                                            />
                                        </div>
                                    ...
                                    <div class="addn-shipping-dets">
                                            ...
                                            <textarea placeholder="Please provide any other info that we should keep in mind regarding your order" id="additional-info" v-model.trim="userShippingAddress.additional_details" name="additional_dets" row="20" column="40" maxlength="250"></textarea>
                                    </div>
   
        
                                    <PriButton button-id="shipping-address-form-btn" button-text="confirm"/>
                                </form>
                            ...
                            <div class="payment-div">
                                ...
                                <PriButton @click="placeOrder" button-id="complete-order-btn" button-text="Place order"/>
...
async function getCartSummary(cartItems: any) {
    ...
    cartItems.query_results.forEach((product: any) => {
        ...
        cartSummaryDetails.value.itemsSubtotal += (product.quantity * Number(product.product.price))
        
    });
    cartSummaryDetails.value.orderTotal += (cartSummaryDetails.value.estimatedTax + 
...
async function placeOrder(){
    ...
    if (!userAddress) {
        appStore.errorMessageToShowOnToast = "Please confirm your shipping address first"
        appStore.showToast()
        return
    }
