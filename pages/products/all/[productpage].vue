    ...
    <div class="products-page-ord">
        ...
        <div class="products-container">
            ...
            <div class="item">
                ...
                <template v-else>
                    <h2>Ooops. There are no products :(. Try again later.</h2>
                </template>
            </div>
...
function showSideBar() {
    ...
    sideBarElement ? sideBarElement.classList.add("showHidden") : alert("sideBarElement element not found")
    sideBarOverlay? sideBarOverlay.classList.add("showSidebarOverlay") : alert("sideBarOverlay element not found")
