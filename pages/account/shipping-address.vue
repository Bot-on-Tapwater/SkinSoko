                    ...
                    <div class="cow-container">
                        <div class="cow-div">
                            ...
                            <div class="cow-dets">
                                ...
                                <form  @submit.prevent="appStore.saveShippingAddress(userShippingAddress)" class="pageForm" id="shippingAddForm">
                                    <div>
                                        <label for="phonenum-field">Phone Number</label>
                                        <input v-model.trim="userShippingAddress.phone_number_1" maxlength="10" id="phonenum-field" type="text" pattern="[0-9]*" title="ENTER NUMBERS ONLY!" inputmode="numeric" required>
                                    </div>
                                    
                                    
                                    <div>
                                        <label for="phone2-field">Phone Number 2*</label>
                                        <input v-model.trim="userShippingAddress.phone_number_2" maxlength="10" id="phone2-field" type="text" pattern="[0-9]*" title="ENTER NUMBERS ONLY!" inputmode="numeric" required>
                                    ...
                                    <PriButton button-id="shipping-address-form-btn" button-text="save changes"/>
                                </form>
